...
<nav id="nav_bar" class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand"  href="?page=utama"><blink><img src="img/icon.png" width="50" height="30" />
                Aplication Absensi</a></blink>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                            <li><a href="?page=jadwal&actions=tampil">Jadwal Kerja</a></li>
                    <li><a href="?page=pegawai&actions=tampil">Data Karyawan</a></li>
